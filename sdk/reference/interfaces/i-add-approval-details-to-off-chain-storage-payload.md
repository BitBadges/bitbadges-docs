...
> `optional` **challengeInfoDetails?**: [`iChallengeInfoDetailsUpdate`](/sdk/reference/interfaces/i-challenge-info-details-update)\<[`NumberType`](/sdk/reference/type-aliases/number-type)\>[]
