---
description: "PathMetadata represents the metadata for paths (alias paths and cosmos coin wrapper paths)."
---

# Class: PathMetadata

Defined in: [packages/bitbadgesjs-sdk/src/core/ibc-wrappers.ts:211](https://github.com/BitBadges/bitbadgesjs/blob/master/packages/bitbadgesjs-sdk/src/core/ibc-wrappers.ts#L211)

PathMetadata represents the metadata for paths (alias paths and cosmos coin wrapper paths).

## Extends

- [`CustomTypeClass`](/sdk/reference/classes/custom-type-class)\<`PathMetadata`\>
...
> **new PathMetadata**(`pathMetadata`): `PathMetadata`

Defined in: [packages/bitbadgesjs-sdk/src/core/ibc-wrappers.ts:215](https://github.com/BitBadges/bitbadgesjs/blob/master/packages/bitbadgesjs-sdk/src/core/ibc-wrappers.ts#L215)
...
> `static` **fromJson**(`jsonValue`, `options?`): `PathMetadata`
...
> `static` **fromJsonString**(`jsonString`, `options?`): `PathMetadata`
...
> `static` **fromProto**(`item`): `PathMetadata`
