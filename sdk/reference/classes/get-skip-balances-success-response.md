---
description: "iGetSkipBalancesSuccessResponse"
---
...
- [`CustomTypeClass`](/sdk/reference/classes/custom-type-class)\<`GetSkipBalancesSuccessResponse`\>
...
> **clone**(): `GetSkipBalancesSuccessResponse`
