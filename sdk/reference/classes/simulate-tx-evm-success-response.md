---
description: "iSimulateTxEvmSuccessResponse"
---
...
- [`CustomTypeClass`](/sdk/reference/classes/custom-type-class)\<`SimulateTxEvmSuccessResponse`\>
...
[`iSimulateTxEvmSuccessResponse`](/sdk/reference/interfaces/i-simulate-tx-evm-success-response).[`gas_used`](/sdk/reference/interfaces/i-simulate-tx-evm-success-response#gas_used)
...
[`iSimulateTxEvmSuccessResponse`](/sdk/reference/interfaces/i-simulate-tx-evm-success-response).[`success`](/sdk/reference/interfaces/i-simulate-tx-evm-success-response#success)

## Methods

### clone()

> **clone**(): `SimulateTxEvmSuccessResponse`
