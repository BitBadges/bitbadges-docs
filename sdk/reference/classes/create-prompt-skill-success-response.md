---
description: "iCreatePromptSkillSuccessResponse"
---

# Class: CreatePromptSkillSuccessResponse

Defined in: [packages/bitbadgesjs-sdk/src/api-indexer/requests/requests.ts:4260](https://github.com/BitBadges/bitbadgesjs/blob/master/packages/bitbadgesjs-sdk/src/api-indexer/requests/requests.ts#L4260)

## Extends

- [`CustomTypeClass`](/sdk/reference/classes/custom-type-class)\<`CreatePromptSkillSuccessResponse`\>
...
> **new CreatePromptSkillSuccessResponse**(`data`): `CreatePromptSkillSuccessResponse`

Defined in: [packages/bitbadgesjs-sdk/src/api-indexer/requests/requests.ts:4262](https://github.com/BitBadges/bitbadgesjs/blob/master/packages/bitbadgesjs-sdk/src/api-indexer/requests/requests.ts#L4262)
...
Defined in: [packages/bitbadgesjs-sdk/src/api-indexer/requests/requests.ts:4261](https://github.com/BitBadges/bitbadgesjs/blob/master/packages/bitbadgesjs-sdk/src/api-indexer/requests/requests.ts#L4261)

#### Implementation of

[`iCreatePromptSkillSuccessResponse`](/sdk/reference/interfaces/i-create-prompt-skill-success-response).[`promptSkillId`](/sdk/reference/interfaces/i-create-prompt-skill-success-response#promptskillid)

## Methods

### clone()

> **clone**(): `CreatePromptSkillSuccessResponse`
