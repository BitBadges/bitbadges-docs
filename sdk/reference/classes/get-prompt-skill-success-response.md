---
description: "iGetPromptSkillSuccessResponse"
---

# Class: GetPromptSkillSuccessResponse

Defined in: [packages/bitbadgesjs-sdk/src/api-indexer/requests/requests.ts:5662](https://github.com/BitBadges/bitbadgesjs/blob/master/packages/bitbadgesjs-sdk/src/api-indexer/requests/requests.ts#L5662)

## Extends

- [`CustomTypeClass`](/sdk/reference/classes/custom-type-class)\<`GetPromptSkillSuccessResponse`\>
...
> **new GetPromptSkillSuccessResponse**(`data`): `GetPromptSkillSuccessResponse`

Defined in: [packages/bitbadgesjs-sdk/src/api-indexer/requests/requests.ts:5665](https://github.com/BitBadges/bitbadgesjs/blob/master/packages/bitbadgesjs-sdk/src/api-indexer/requests/requests.ts#L5665)
...
> **promptSkill**: [`iPromptSkillDoc`](/sdk/reference/interfaces/i-prompt-skill-doc)

Defined in: [packages/bitbadgesjs-sdk/src/api-indexer/requests/requests.ts:5663](https://github.com/BitBadges/bitbadgesjs/blob/master/packages/bitbadgesjs-sdk/src/api-indexer/requests/requests.ts#L5663)

#### Implementation of

[`iGetPromptSkillSuccessResponse`](/sdk/reference/interfaces/i-get-prompt-skill-success-response).[`promptSkill`](/sdk/reference/interfaces/i-get-prompt-skill-success-response#promptskill)

## Methods

### clone()

> **clone**(): `GetPromptSkillSuccessResponse`
