...
- [`CustomTypeClass`](/sdk/reference/classes/custom-type-class)\<`VerifySignInSuccessResponse`\>
...
[`iVerifySignInSuccessResponse`](/sdk/reference/interfaces/i-verify-sign-in-success-response).[`message`](/sdk/reference/interfaces/i-verify-sign-in-success-response#message)

## Methods

### clone()

> **clone**(): `VerifySignInSuccessResponse`
