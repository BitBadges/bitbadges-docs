---
description: "iGetSignInChallengePayload"
---
...
- [`CustomTypeClass`](/sdk/reference/classes/custom-type-class)\<`GetSignInChallengePayload`\>
...
[`iGetSignInChallengePayload`](/sdk/reference/interfaces/i-get-sign-in-challenge-payload).[`address`](/sdk/reference/interfaces/i-get-sign-in-challenge-payload#address)
...
[`iGetSignInChallengePayload`](/sdk/reference/interfaces/i-get-sign-in-challenge-payload).[`chain`](/sdk/reference/interfaces/i-get-sign-in-challenge-payload#chain)

## Methods

### clone()

> **clone**(): `GetSignInChallengePayload`
