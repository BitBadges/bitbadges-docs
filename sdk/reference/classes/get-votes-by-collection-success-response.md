...
- [`BaseNumberTypeClass`](/sdk/reference/classes/base-number-type-class)\<`GetVotesByCollectionSuccessResponse`\<`T`\>\>
...
- [`iGetVotesByCollectionSuccessResponse`](/sdk/reference/interfaces/i-get-votes-by-collection-success-response)\<`T`\>
...
`GetVotesByCollectionSuccessResponse`\<`T`\>
...
[`iGetVotesByCollectionSuccessResponse`](/sdk/reference/interfaces/i-get-votes-by-collection-success-response).[`pagination`](/sdk/reference/interfaces/i-get-votes-by-collection-success-response#pagination)
...
[`iGetVotesByCollectionSuccessResponse`](/sdk/reference/interfaces/i-get-votes-by-collection-success-response).[`votes`](/sdk/reference/interfaces/i-get-votes-by-collection-success-response#votes)

## Methods

### clone()

> **clone**(): `GetVotesByCollectionSuccessResponse`
...
`GetVotesByCollectionSuccessResponse`\<`U`\>
