---
description: "iAddApprovalDetailsToOffChainStorageSuccessResponse"
---
...
- [`CustomTypeClass`](/sdk/reference/classes/custom-type-class)\<`AddApprovalDetailsToOffChainStorageSuccessResponse`\>
...
> `optional` **challengeResults?**: `object`[]
...
[`iAddApprovalDetailsToOffChainStorageSuccessResponse`](/sdk/reference/interfaces/i-add-approval-details-to-off-chain-storage-success-response).[`approvalResults`](/sdk/reference/interfaces/i-add-approval-details-to-off-chain-storage-success-response#approvalresults)

## Methods

### clone()

> **clone**(): `AddApprovalDetailsToOffChainStorageSuccessResponse`
