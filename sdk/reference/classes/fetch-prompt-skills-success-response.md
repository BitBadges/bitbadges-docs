---
description: "iFetchPromptSkillsSuccessResponse"
---

# Class: FetchPromptSkillsSuccessResponse

Defined in: [packages/bitbadgesjs-sdk/src/api-indexer/requests/requests.ts:5689](https://github.com/BitBadges/bitbadgesjs/blob/master/packages/bitbadgesjs-sdk/src/api-indexer/requests/requests.ts#L5689)

## Extends

- [`CustomTypeClass`](/sdk/reference/classes/custom-type-class)\<`FetchPromptSkillsSuccessResponse`\>
...
> **new FetchPromptSkillsSuccessResponse**(`data`): `FetchPromptSkillsSuccessResponse`

Defined in: [packages/bitbadgesjs-sdk/src/api-indexer/requests/requests.ts:5695](https://github.com/BitBadges/bitbadgesjs/blob/master/packages/bitbadgesjs-sdk/src/api-indexer/requests/requests.ts#L5695)
...
Defined in: [packages/bitbadgesjs-sdk/src/api-indexer/requests/requests.ts:5693](https://github.com/BitBadges/bitbadgesjs/blob/master/packages/bitbadgesjs-sdk/src/api-indexer/requests/requests.ts#L5693)

#### Implementation of

[`iFetchPromptSkillsSuccessResponse`](/sdk/reference/interfaces/i-fetch-prompt-skills-success-response).[`promptSkills`](/sdk/reference/interfaces/i-fetch-prompt-skills-success-response#promptskills)

## Methods

### clone()

> **clone**(): `FetchPromptSkillsSuccessResponse`
