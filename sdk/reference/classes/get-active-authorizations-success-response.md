...
- [`CustomTypeClass`](/sdk/reference/classes/custom-type-class)\<`GetActiveAuthorizationsSuccessResponse`\<`T`\>\>
...
- [`iGetActiveAuthorizationsSuccessResponse`](/sdk/reference/interfaces/i-get-active-authorizations-success-response)\<`T`\>
...
`GetActiveAuthorizationsSuccessResponse`\<`T`\>
...
[`iGetActiveAuthorizationsSuccessResponse`](/sdk/reference/interfaces/i-get-active-authorizations-success-response).[`authorizations`](/sdk/reference/interfaces/i-get-active-authorizations-success-response#authorizations)
...
[`iGetActiveAuthorizationsSuccessResponse`](/sdk/reference/interfaces/i-get-active-authorizations-success-response).[`developerApps`](/sdk/reference/interfaces/i-get-active-authorizations-success-response#developerapps)

## Methods

### clone()

> **clone**(): `GetActiveAuthorizationsSuccessResponse`
