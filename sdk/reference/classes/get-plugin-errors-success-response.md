---
description: "iGetPluginErrorsSuccessResponse"
---
...
- [`CustomTypeClass`](/sdk/reference/classes/custom-type-class)\<`GetPluginErrorsSuccessResponse`\>
...
[`iGetPluginErrorsSuccessResponse`](/sdk/reference/interfaces/i-get-plugin-errors-success-response).[`bookmark`](/sdk/reference/interfaces/i-get-plugin-errors-success-response#bookmark)
...
[`iGetPluginErrorsSuccessResponse`](/sdk/reference/interfaces/i-get-plugin-errors-success-response).[`docs`](/sdk/reference/interfaces/i-get-plugin-errors-success-response#docs)
...
[`iGetPluginErrorsSuccessResponse`](/sdk/reference/interfaces/i-get-plugin-errors-success-response).[`total`](/sdk/reference/interfaces/i-get-plugin-errors-success-response#total)

## Methods

### clone()

> **clone**(): `GetPluginErrorsSuccessResponse`
