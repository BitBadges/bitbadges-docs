---
description: "iGetOwnersPayload"
---

# Class: GetOwnersPayload

Defined in: [packages/bitbadgesjs-sdk/src/api-indexer/requests/collections.ts:125](https://github.com/BitBadges/bitbadgesjs/blob/master/packages/bitbadgesjs-sdk/src/api-indexer/requests/collections.ts#L125)

## Extends

- [`CustomTypeClass`](/sdk/reference/classes/custom-type-class)\<`GetOwnersPayload`\>
...
> **new GetOwnersPayload**(`payload`): `GetOwnersPayload`

Defined in: [packages/bitbadgesjs-sdk/src/api-indexer/requests/collections.ts:129](https://github.com/BitBadges/bitbadgesjs/blob/master/packages/bitbadgesjs-sdk/src/api-indexer/requests/collections.ts#L129)
...
Defined in: [packages/bitbadgesjs-sdk/src/api-indexer/requests/collections.ts:126](https://github.com/BitBadges/bitbadgesjs/blob/master/packages/bitbadgesjs-sdk/src/api-indexer/requests/collections.ts#L126)
...
[`iGetOwnersPayload`](/sdk/reference/interfaces/i-get-owners-payload).[`bookmark`](/sdk/reference/interfaces/i-get-owners-payload#bookmark)
...
Defined in: [packages/bitbadgesjs-sdk/src/api-indexer/requests/collections.ts:127](https://github.com/BitBadges/bitbadgesjs/blob/master/packages/bitbadgesjs-sdk/src/api-indexer/requests/collections.ts#L127)

Sort by amount descending.

#### Implementation of

[`iGetOwnersPayload`](/sdk/reference/interfaces/i-get-owners-payload).[`sortBy`](/sdk/reference/interfaces/i-get-owners-payload#sortby)

## Methods

### clone()

> **clone**(): `GetOwnersPayload`
...
> `static` **FromQuery**(`query`): `GetOwnersPayload`

Defined in: [packages/bitbadgesjs-sdk/src/api-indexer/requests/collections.ts:135](https://github.com/BitBadges/bitbadgesjs/blob/master/packages/bitbadgesjs-sdk/src/api-indexer/requests/collections.ts#L135)
