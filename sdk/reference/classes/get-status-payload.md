...
- [`CustomTypeClass`](/sdk/reference/classes/custom-type-class)\<`GetStatusPayload`\>
...
[`iGetStatusPayload`](/sdk/reference/interfaces/i-get-status-payload).[`chain`](/sdk/reference/interfaces/i-get-status-payload#chain)
...
[`iGetStatusPayload`](/sdk/reference/interfaces/i-get-status-payload).[`withOutOfSyncCheck`](/sdk/reference/interfaces/i-get-status-payload#withoutofsynccheck)

## Methods

### clone()

> **clone**(): `GetStatusPayload`
