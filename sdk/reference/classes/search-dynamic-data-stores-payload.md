---
description: "iSearchDynamicDataStoresPayload"
---
...
- [`CustomTypeClass`](/sdk/reference/classes/custom-type-class)\<`SearchDynamicDataStoresPayload`\>
...
`SearchDynamicDataStoresPayload`
...
[`iSearchDynamicDataStoresPayload`](/sdk/reference/interfaces/i-search-dynamic-data-stores-payload).[`bookmark`](/sdk/reference/interfaces/i-search-dynamic-data-stores-payload#bookmark)

## Methods

### clone()

> **clone**(): `SearchDynamicDataStoresPayload`
