---
description: "iGetBalanceByAddressPayload"
---

# Class: GetBalanceByAddressPayload

Defined in: [packages/bitbadgesjs-sdk/src/api-indexer/requests/collections.ts:240](https://github.com/BitBadges/bitbadgesjs/blob/master/packages/bitbadgesjs-sdk/src/api-indexer/requests/collections.ts#L240)

## Extends

- [`CustomTypeClass`](/sdk/reference/classes/custom-type-class)\<`GetBalanceByAddressPayload`\>
...
> **new GetBalanceByAddressPayload**(`payload`): `GetBalanceByAddressPayload`

Defined in: [packages/bitbadgesjs-sdk/src/api-indexer/requests/collections.ts:244](https://github.com/BitBadges/bitbadgesjs/blob/master/packages/bitbadgesjs-sdk/src/api-indexer/requests/collections.ts#L244)
...
Defined in: [packages/bitbadgesjs-sdk/src/api-indexer/requests/collections.ts:241](https://github.com/BitBadges/bitbadgesjs/blob/master/packages/bitbadgesjs-sdk/src/api-indexer/requests/collections.ts#L241)
...
[`iGetBalanceByAddressPayload`](/sdk/reference/interfaces/i-get-balance-by-address-payload).[`fetchPrivateParams`](/sdk/reference/interfaces/i-get-balance-by-address-payload#fetchprivateparams)
...
Defined in: [packages/bitbadgesjs-sdk/src/api-indexer/requests/collections.ts:242](https://github.com/BitBadges/bitbadgesjs/blob/master/packages/bitbadgesjs-sdk/src/api-indexer/requests/collections.ts#L242)
...
[`iGetBalanceByAddressPayload`](/sdk/reference/interfaces/i-get-balance-by-address-payload).[`forceful`](/sdk/reference/interfaces/i-get-balance-by-address-payload#forceful)

## Methods

### clone()

> **clone**(): `GetBalanceByAddressPayload`
...
> `static` **FromQuery**(`query`): `GetBalanceByAddressPayload`

Defined in: [packages/bitbadgesjs-sdk/src/api-indexer/requests/collections.ts:250](https://github.com/BitBadges/bitbadgesjs/blob/master/packages/bitbadgesjs-sdk/src/api-indexer/requests/collections.ts#L250)
