...
- [`BaseNumberTypeClass`](/sdk/reference/classes/base-number-type-class)\<`GetCollectionsSuccessResponse`\<`T`\>\>
...
- [`iGetCollectionsSuccessResponse`](/sdk/reference/interfaces/i-get-collections-success-response)\<`T`\>
...
`GetCollectionsSuccessResponse`\<`T`\>
...
[`iGetCollectionsSuccessResponse`](/sdk/reference/interfaces/i-get-collections-success-response).[`collections`](/sdk/reference/interfaces/i-get-collections-success-response#collections)

## Methods

### clone()

> **clone**(): `GetCollectionsSuccessResponse`
...
`GetCollectionsSuccessResponse`\<`U`\>
