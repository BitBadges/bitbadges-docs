---
description: "iSearchPromptSkillsSuccessResponse"
---

# Class: SearchPromptSkillsSuccessResponse
...
- [`CustomTypeClass`](/sdk/reference/classes/custom-type-class)\<`SearchPromptSkillsSuccessResponse`\>
...
> **new SearchPromptSkillsSuccessResponse**(`data`): `SearchPromptSkillsSuccessResponse`

Defined in: [packages/bitbadgesjs-sdk/src/api-indexer/requests/requests.ts:4334](https://github.com/BitBadges/bitbadgesjs/blob/master/packages/bitbadgesjs-sdk/src/api-indexer/requests/requests.ts#L4334)
...
Defined in: [packages/bitbadgesjs-sdk/src/api-indexer/requests/requests.ts:4332](https://github.com/BitBadges/bitbadgesjs/blob/master/packages/bitbadgesjs-sdk/src/api-indexer/requests/requests.ts#L4332)

#### Implementation of

[`iSearchPromptSkillsSuccessResponse`](/sdk/reference/interfaces/i-search-prompt-skills-success-response).[`bookmark`](/sdk/reference/interfaces/i-search-prompt-skills-success-response#bookmark)

***

### promptSkills

> **promptSkills**: [`iPromptSkillDoc`](/sdk/reference/interfaces/i-prompt-skill-doc)[]

Defined in: [packages/bitbadgesjs-sdk/src/api-indexer/requests/requests.ts:4331](https://github.com/BitBadges/bitbadgesjs/blob/master/packages/bitbadgesjs-sdk/src/api-indexer/requests/requests.ts#L4331)

#### Implementation of

[`iSearchPromptSkillsSuccessResponse`](/sdk/reference/interfaces/i-search-prompt-skills-success-response).[`promptSkills`](/sdk/reference/interfaces/i-search-prompt-skills-success-response#promptskills)

## Methods

### clone()

> **clone**(): `SearchPromptSkillsSuccessResponse`
