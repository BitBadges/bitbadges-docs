---
description: "iGetSwapStatusSuccessResponse"
---
...
- [`CustomTypeClass`](/sdk/reference/classes/custom-type-class)\<`GetSwapStatusSuccessResponse`\>
...
[`iGetSwapStatusSuccessResponse`](/sdk/reference/interfaces/i-get-swap-status-success-response).[`swapEventInfo`](/sdk/reference/interfaces/i-get-swap-status-success-response#swapeventinfo)
...
[`iGetSwapStatusSuccessResponse`](/sdk/reference/interfaces/i-get-swap-status-success-response).[`transfers`](/sdk/reference/interfaces/i-get-swap-status-success-response#transfers)

## Methods

### clone()

> **clone**(): `GetSwapStatusSuccessResponse`
