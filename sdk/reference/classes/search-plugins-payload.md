---
description: "iSearchPluginsPayload"
---
...
- [`CustomTypeClass`](/sdk/reference/classes/custom-type-class)\<`SearchPluginsPayload`\>
...
[`iSearchPluginsPayload`](/sdk/reference/interfaces/i-search-plugins-payload).[`bookmark`](/sdk/reference/interfaces/i-search-plugins-payload#bookmark)
...
[`iSearchPluginsPayload`](/sdk/reference/interfaces/i-search-plugins-payload).[`locale`](/sdk/reference/interfaces/i-search-plugins-payload#locale)
...
[`iSearchPluginsPayload`](/sdk/reference/interfaces/i-search-plugins-payload).[`searchValue`](/sdk/reference/interfaces/i-search-plugins-payload#searchvalue)

## Methods

### clone()

> **clone**(): `SearchPluginsPayload`
