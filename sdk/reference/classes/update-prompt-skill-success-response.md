...
# Class: UpdatePromptSkillSuccessResponse

Defined in: [packages/bitbadgesjs-sdk/src/api-indexer/requests/requests.ts:4290](https://github.com/BitBadges/bitbadgesjs/blob/master/packages/bitbadgesjs-sdk/src/api-indexer/requests/requests.ts#L4290)
...
> **new UpdatePromptSkillSuccessResponse**(`data?`): `UpdatePromptSkillSuccessResponse`
