...
# Class: RefreshStatusPayload

Defined in: [packages/bitbadgesjs-sdk/src/api-indexer/requests/collections.ts:476](https://github.com/BitBadges/bitbadgesjs/blob/master/packages/bitbadgesjs-sdk/src/api-indexer/requests/collections.ts#L476)
...
> **new RefreshStatusPayload**(`data?`): `RefreshStatusPayload`
