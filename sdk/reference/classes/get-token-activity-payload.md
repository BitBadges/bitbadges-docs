---
description: "iGetTokenActivityPayload"
---

# Class: GetTokenActivityPayload

Defined in: [packages/bitbadgesjs-sdk/src/api-indexer/requests/collections.ts:282](https://github.com/BitBadges/bitbadgesjs/blob/master/packages/bitbadgesjs-sdk/src/api-indexer/requests/collections.ts#L282)

## Extends

- [`CustomTypeClass`](/sdk/reference/classes/custom-type-class)\<`GetTokenActivityPayload`\>
...
> **new GetTokenActivityPayload**(`payload`): `GetTokenActivityPayload`

Defined in: [packages/bitbadgesjs-sdk/src/api-indexer/requests/collections.ts:286](https://github.com/BitBadges/bitbadgesjs/blob/master/packages/bitbadgesjs-sdk/src/api-indexer/requests/collections.ts#L286)
...
Defined in: [packages/bitbadgesjs-sdk/src/api-indexer/requests/collections.ts:284](https://github.com/BitBadges/bitbadgesjs/blob/master/packages/bitbadgesjs-sdk/src/api-indexer/requests/collections.ts#L284)

Specific address to filter by. If not present, all activity will be returned.

#### Implementation of

[`iGetTokenActivityPayload`](/sdk/reference/interfaces/i-get-token-activity-payload).[`bitbadgesAddress`](/sdk/reference/interfaces/i-get-token-activity-payload#bitbadgesaddress)
...
Defined in: [packages/bitbadgesjs-sdk/src/api-indexer/requests/collections.ts:283](https://github.com/BitBadges/bitbadgesjs/blob/master/packages/bitbadgesjs-sdk/src/api-indexer/requests/collections.ts#L283)

An optional bookmark for pagination. Bookmarks are obtained via the previous response. "" for first request.

#### Implementation of

[`iGetTokenActivityPayload`](/sdk/reference/interfaces/i-get-token-activity-payload).[`bookmark`](/sdk/reference/interfaces/i-get-token-activity-payload#bookmark)

## Methods

### clone()

> **clone**(): `GetTokenActivityPayload`
...
> `static` **FromQuery**(`query`): `GetTokenActivityPayload`

Defined in: [packages/bitbadgesjs-sdk/src/api-indexer/requests/collections.ts:292](https://github.com/BitBadges/bitbadgesjs/blob/master/packages/bitbadgesjs-sdk/src/api-indexer/requests/collections.ts#L292)
