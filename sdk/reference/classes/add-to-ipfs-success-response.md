---
description: "iAddToIpfsSuccessResponse"
---
...
- [`CustomTypeClass`](/sdk/reference/classes/custom-type-class)\<`AddToIpfsSuccessResponse`\>
...
[`iAddToIpfsSuccessResponse`](/sdk/reference/interfaces/i-add-to-ipfs-success-response).[`results`](/sdk/reference/interfaces/i-add-to-ipfs-success-response#results)

## Methods

### clone()

> **clone**(): `AddToIpfsSuccessResponse`
