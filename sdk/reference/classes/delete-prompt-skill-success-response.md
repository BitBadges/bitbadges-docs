...
# Class: DeletePromptSkillSuccessResponse

Defined in: [packages/bitbadgesjs-sdk/src/api-indexer/requests/requests.ts:4307](https://github.com/BitBadges/bitbadgesjs/blob/master/packages/bitbadgesjs-sdk/src/api-indexer/requests/requests.ts#L4307)
...
> **new DeletePromptSkillSuccessResponse**(`data?`): `DeletePromptSkillSuccessResponse`
