---
description: "iGetReservedClaimCodesSuccessResponse"
---
...
- [`CustomTypeClass`](/sdk/reference/classes/custom-type-class)\<`GetReservedClaimCodesSuccessResponse`\>
...
[`iGetReservedClaimCodesSuccessResponse`](/sdk/reference/interfaces/i-get-reserved-claim-codes-success-response).[`leafSignatures`](/sdk/reference/interfaces/i-get-reserved-claim-codes-success-response#leafsignatures)
...
[`iGetReservedClaimCodesSuccessResponse`](/sdk/reference/interfaces/i-get-reserved-claim-codes-success-response).[`reservedCodes`](/sdk/reference/interfaces/i-get-reserved-claim-codes-success-response#reservedcodes)

## Methods

### clone()

> **clone**(): `GetReservedClaimCodesSuccessResponse`
