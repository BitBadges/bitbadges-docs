---
description: "Check if a message type is a Distribution message (uses Distribution precompile)"
---

# Function: isDistributionMessage()
...
true if the message type is a Distribution message
